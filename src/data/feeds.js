export const dataFeeds = [
  { key: 'estagio', name: 'Estagio Cidade', latency: '-', ok: false },
  { key: 'calor', name: 'Calor COR', latency: '-', ok: false },
  { key: 'pluviometricos', name: 'Pluviometros', latency: '-', ok: false },
  { key: 'sirenes', name: 'Sirenes COR', latency: '-', ok: false },
